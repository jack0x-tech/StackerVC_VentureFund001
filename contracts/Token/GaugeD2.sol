...
contract GaugeD2 is IERC20, ReentrancyGuard {
    ...
    address payable public governance = 0x3748fBC77D24958cf374A93F2d2AD5768fe34351; // TODO: STACK DAO Agent address
    address public constant acceptToken = 0x0572bf36dBD8BBF41ACfaA74139B20ED8a7C0366; // TODO: stackToken rebase token

    address public constant STACK = 0x24E203A5c1Be11aA94d2554a96d8F42513FB5b51; // TODO: get STACK token address

    uint256 public emissionRate = 100e18/100000; // TODO: final emission rate

    uint256 public depositedShares;

    uint256 public constant startBlock = 8263459 + 100; // TODO: start block
